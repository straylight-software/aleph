...
let
  ...
  test-lib-nv-utils = pkgs.runCommand "test-lib-nv-utils" { } (
    pkgs.replaceVars ./scripts/test-lib-nv-utils.bash {
      ...
      nvccFlags = straylightLib.nv.nvcc-flags [
        "8.0"
        "9.0"
      ];
    }
  ...
  test-lib-stdenv-utils = pkgs.runCommand "test-lib-stdenv-utils" { } (
    pkgs.replaceVars ./scripts/test-lib-stdenv-utils.bash {
      straylightCflags = straylightLib.stdenv.straylight-cflags;
      dontStrip = builtins.toJSON straylightLib.stdenv.straylight-attrs.dontStrip;
      hardeningDisableAll = builtins.toJSON (
