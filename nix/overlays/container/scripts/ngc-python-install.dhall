-- nix/overlays/container/scripts/ngc-python-install.dhall
--
-- Install script for NGC container Python packages
-- Environment variables are injected by render.dhall-with-vars

let pythonVersion : Text = env:PYTHON_VERSION as Text
