-- nix/modules/flake/scripts/lre-start.dhall
--
-- NativeLink startup script for local remote execution
-- Environment variables are injected by render.dhall-with-vars

let defaultWorkers : Text = env:DEFAULT_WORKERS as Text
let defaultPort : Text = env:DEFAULT_PORT as Text
let nativelink : Text = env:NATIVELINK as Text
