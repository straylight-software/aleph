-- nix/modules/flake/build/scripts/shell-hook-prelude.dhall
--
-- Shell hook for linking buck2-prelude and toolchains
-- Environment variables are injected by render.dhall-with-vars

let preludeSrc : Text = env:PRELUDE_SRC as Text
let toolchainsSrc : Text = env:TOOLCHAINS_SRC as Text
