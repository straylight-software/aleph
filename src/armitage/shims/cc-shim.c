...
static int is_source_file(const char *path) {
  ...
  return strcmp(ext, ".c") == 0 || strcmp(ext, ".cc") == 0 ||
         ...
         strcmp(ext, ".C") == 0 || strcmp(ext, ".c++") == 0 ||
         strcmp(ext, ".cu") == 0 || strcmp(ext, ".m") == 0 ||
         strcmp(ext, ".mm") == 0 || strcmp(ext, ".S") == 0 ||
         strcmp(ext, ".s") == 0;
}
...
static int write_fake_object(const char *path) {
  ...
  const char *sym_values[] = {
      "",          sources_str, includes_str,
      defines_str, flags_str,   output_file ? output_file : "",
  };
